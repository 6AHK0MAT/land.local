...
<section class="page_section team" id="price"><!--main-section team-start-->
    <div class="container">
        <h2>Прайс</h2>
...
<footer class="footer_wrapper" id="contact">
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © 2017    <a href="http://act.ru/"> А С Т</a> </span> </div>
  </div>
</footer>